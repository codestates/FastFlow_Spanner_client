const ScrollYear = props => {
  ...
  return (     
    <div className="scrollYears">
      <div className={`${scrollTop}`<500?"scrollYear_on":"scrollYear_out"}>Spanner</div>
      <div className={`${scrollTop}`>=500?( `${scrollTop}`<1500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<1500?"scrollYear_in":"")}>BC 1.6M</div>
      <div className={`${scrollTop}`>=1500?( `${scrollTop}`<2500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<2500?"scrollYear_in":"")}>BC 0.6M</div>
      <div className={`${scrollTop}`>=2500?( `${scrollTop}`<3500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<3500?"scrollYear_in":"")}>BC 3.5k</div>
      <div className={`${scrollTop}`>=3500?( `${scrollTop}`<4500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<4500?"scrollYear_in":"")}>BC 3.5k</div>
      <div className={`${scrollTop}`>=4500?( `${scrollTop}`<5500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<5500?"scrollYear_in":"")}>BC 3.0k</div>
      <div className={`${scrollTop}`>=5500?( `${scrollTop}`<6500?"scrollYear_on":"scrollYear_out"):( `${scrollTop}`<6500?"scrollYear_in":"")}>BC 1.6k</div>
