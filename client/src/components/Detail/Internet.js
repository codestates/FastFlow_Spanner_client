      ...
      <div className="Details__body">
        ...
        <div className="Details__textArea">
          ...
          <div className="Details__text">
            ...
            <p>
            인터넷의 역사는 1950년대에 컴퓨터의 개발과 더불어 시작하였다. 메인프레임 컴퓨터와 단말기 
            간의 점대점 통신과 더불어 개시되었고 컴퓨터 간 점대점 연결로, 그 뒤 초기 연구가 패킷 교환
            으로 확장되었다.
            폴 바란은 1960년대 초에 메시지 블록 데이터를 기반으로 분산 네트워크를 제안했고, 아파넷, 
            영국 NPL의 마크 I, CYCLADES, 메리트 네트워크, 타임넷, 텔레넷과 같은 패킷 교환망은 
            1960년대 말과 1970년대 초에 다양한 프로토콜을 이용하여 개발되었다. 아파넷으로 말미암아 
            특히 인터네트워킹을 위한 프로토콜이 개발되었으며 여기서 서로 떨어진 여러 개의 망들이 
            여러 네트워크의 한 네트워크로 함께 결합할 수 있었다.
            1981년 미국 국립과학재단(NSF)이 CSNET(컴퓨터 과학망)을 개발하면서 아파넷으로의 접속이 
            확장되었으며 1982년 인터넷 프로토콜 스위트 (TCP/IP)가 표준화되었고 인터넷이라 불리는, 
            완전히 상호 연결되는 TCP/IP 네트워크의 월드 와이드 네트워크의 개념이 등장하였다.             
            아파넷은 1990년에 직권이 해제되었다. 인터넷은 NSFNET의 직권이 해제된 1995년에 시장에 
            들어왔으며, 이로써 상용 트래픽을 전달하기 위한 인터넷 사용의 마지막 제한이 제거되었다.            
            </p>
            ...
            <p>
            우리가 일상생활에서 흔히 “인터넷”이라 부르는 것은 엄밀하게 말하자면 인터넷이 아닌 
            월드와이드웹 (World Wide Web)으로, 인터넷이라는 국제 네트워크 위에 링크로 서로 연결되는 
            텍스트인 “하이퍼텍스트”라는 개념을 더한 것이다. 인터넷 그 자체는 단순한 국제 네트워크일 
            뿐이다. 1991년 CERN에서 근무하던 팀 버너스 리 경에 의해 개발되어 배포된 월드와이드웹 — 
            즉 TCP/IP 위에서 구동되는 HTTP, HTML, 웹 브라우저 등의 프로토콜과 소프트웨어 — 은, 
            주로 연구기관들에서 정보 교환을 위해 사용되던 인터넷을 모두가 사용하는 네트워크로 
            대중화하는 데에 핵심적인 기여를 했다.
            </p>
          </div>
        </div>
      </div>
