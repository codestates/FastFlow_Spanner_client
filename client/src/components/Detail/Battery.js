      ...
      <div className="Details__body">
        ...
        <div className="Details__textArea">
          ...
          <div className="Details__text">
            ...
            <p>
            세계에서 가장 오래된 전지는 항아리 전지라고도 알려진 약 2000년 전에 만들어진 바그다드 전지이다.
            이 전지는 금이나 은을 도금하는 용도로 사용했을 것으로 추정된다. 
            이후 1800년 구리와 아연을 이용해 세계 최초의 전기 저장 장치인 볼타전지를 만든 
            이탈리아의 알레산드로 볼타가 배터리의 아버지라 불리고 있다. 
            이 공로로 전기의 단위도 그의 이름과 같이 볼트(V)로 정했다.
            1896년 William W. Jacques는 최초로 연료전지 실용화 제품을 개발하였고, 
            1900년에 Walther Nernst는 최초로 고체 전해질로 지르코늄을 사용하였다.
            이후  인류는 소재와 구조 개발을 통해 배터리를 경량화하고 고효율화 해왔다.
            </p>
            <div className="Details__text__make">원리</div>
            <p>
              리튬 이온 배터리는 양극, 음극, 분리막, 전해질이라는 4대 구성요소로 이루어 진다.
              양극(+)은 리튬과 산소가 만난 리튬산화물로 구성되는데, 충전 시에는 양극을 이루는 물질 중
              리튬이온만 빠져나와서 분리막을 통해 음극으로 옮겨가고, 방전 시에는 리튬이온이 원래 머물던
              양극으로 돌아가면서 전기가 발생하게 된다.
            </p>
            <div className="Details__text__use">왜 리튬 이온 배터리인가?</div>
            <p>
              가장 중요한 점은 알칼리, 니켈 카드뮴 등 다른 배터리 재료들에 비해 가장 높은 에너지 밀도를 갖고 있다는 점이다.
              산화물로 구성될 시에 안정성도 높아지고, 충전 주기 및 수명이 길다. 또한 자연 방전율이 다른 재료에 비해 낮다.
            </p>
          </div>
        </div>
      </div>
