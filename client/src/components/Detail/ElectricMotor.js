      ...
      <div className="Details__body">
        ...
        <div className="Details__textArea">
          ...
          <div className="Details__text">
            ...
            <p>
            1800년대 초, 외르스테드, 패러데이, 가우스, 암페어는 전자기 유도의 기본 이론을 정립하였다.
            1821년 영국의 패러데이는 실험을 통해 전기에너지를 운동에너지로 바꿀 수 있다는 것을 실험적으로
            증명하였다. 이후 직류전원(DC)과 정류자(Commutator)를 발명하여, 오늘날 DC모터가 필수적으로 사용하는
            연속 회전 운동을 최초로 개발하게 되었다.
            1870년대에 들어서는 에디슨과 테슬라 등에 의한 교류(AC) 모터와 삼상 교류에 의한 회전 자기장
            유도 모터로 발전되었으며, 스위칭 기능, 인터버 적용 등으로 현대까지 꾸준히 발전해오고 있다.
            </p>
            <div className="Details__text__make">원리</div>
            <p>
              직류 전동기는 자석 사이에 있는 코일에 전류가 흐를 때 자석과 코일 사이에 작용하는 자기력에 의해
              코일이 회전하게 되며, 코일이 회전하여 코일의 면이 자기장에 수직이 되는 순간 정류자에 의하여
              전류의 방향이 바뀌므로 코일은 계속해서 한쪽 방향으로 회전하게 된다. 소형 장난감 및 청소기 등에
              사용되는 전동기는 보통 직류 전동기이다.
              교류 전동기는 이와 다르게 정류자(브러시)가 없는 형태이며, 이것은 주로 전동기에 인가되는
              전류의 방향을 교류의 형태로 계속 바꿔주기 때문이다.
            </p>
            <div className="Details__text__use">왜 모터는 소음이 발생할까?</div>
            <p>
              모터는 왜 시끄러울까? 모터에 의한 소음은 다음과 같이 크게 전자기적 소음, 기계적 소음, 통풍
              소음으로 구분할 수 있다. 전자기적 소음은 고정자, 회전자에 작용하는 전자기력에 의해 철심이
              진동하면서 발생하는 소음이다. 기계적 소음은 베어링, 회전자, 브러시 등에 의한 기계적 오차에
              의한 소음이다. 통풍 소음은 냉각팬, 덕트 등에서의 공기의 압축, 팽창에 의한 진동음이다.              
            </p>
          </div>
        </div>
      </div>
