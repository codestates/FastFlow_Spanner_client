      ...
      <div className="Details__body">
        ...
        <div className="Details__textArea">
          ...
          <div className="Details__text">
            ...
            <p>
            비행기에 대한 기초적인 이론과 형태는 레오나르도 다빈치로부터 시작되었다. 16세기 초 레오나르도
            다빈치는 새가 하늘을 나는 원리를 연구하여 새가 자기의 무게를 받쳐줄 수 있을 정도로 충분한
            공기의 밀도 층 위에서는 뜨게 된다는 것을 발견하였다.
            인간이 실제로 기구를 타고 하늘을 날게된 것은 18세기 말경이였다. 프랑스의 몽골피에 형제가
            열기구를 발명하였다. 1783년에는 세계 최초로 약 500m 높이로 9km를 25분 정도 비행하는데 성공하였다.
            1891년 독일의 릴리엔탈은 자신이 제작한 글라이더를 타고 직접 비행하는데 성공하였으며, 1903년
            라이트 형제에 의해 인류의 역사가 시작된 이후 최초로 인간이 동력에 의한 비행에 성공을 거두었다.
            </p>
            <div className="Details__text__make">원리</div>
            <p>
              비행기가 뜨는 원리는 베르누이의 원리와 뉴턴의 제 3법칙에 의한 것이다. 유선형의 날개 모양 때문에,
              비행기가 모터에 의해서 앞으로 전진하면 날개의 위쪽 공기는 좁은 관을 지나가는 유체가 속력이
              빨라지는 것과 같이 속력이 빨라진다. 속력이 빠른 유체는 압력이 낮아진다는 것이 베르누이의 원리이다.
              즉, 비행기 날개 아래쪽의 느린 공기는 압력이 크고, 위쪽의 빠른 공기는 압력이 작으므로 이 압력의
              차이에 의해서 날개에 위로 향하는 힘이 생기게 된다.
              비행기가 빠르게 앞으로 나가면서, 앞쪽의 공기에 힘을 가하게 된다. 뉴턴의 제 3법칙, 작용-반작용의
              법칙에 따라 공기는 반작용력을 비행기 날개에 전달하게 된다. 진행방향에 대해서 경사면을 갖는 비행기
              날개는 공기의 반작용력에 의해 지면으로부터 수직방향으로 힘을 받아 비행기를 위로 올려주게 된다.
            </p>
            <div className="Details__text__use">비행기 실내 온도는 어떻게 조절할까?</div>
            <p>
            항공기의 냉난방 시스템은 연료 소모와는 거의 무관한 데 이는 엔진에서 발산하는 열을 부가적으로 
            활용하기 때문이다.  즉, 항공기는 엔진을 통해서 흡입하는 영하 40 정도의 차가운 외부 온도를 
            흡입하여 적당하게 가열을 통하여 필요한 온도로 데워서 승객들에게 공급을 하게 되는데 
            공기의 온도를 조절하는 것은 항공기에 장착된 PACK 이라는 장비가 담당한다.
            항공기 객실 온도 조절은 조종실에서 주 온도 조절장치를 통해 설정하고 객실에서는 
            이미 설정된 기준온도에서 상하 6-8도 정도 범위 내에서 재 조절할 수 있다.
            대부분의 상용 여객기는 대개 온도 조절 장치를 통해 언제든지 온도 조절이 가능하지만,
            일부 항공 기종의 경우는 제한적 기능으로 온도 조절이 적절하지 못할 수 있다.
            </p>
          </div>
        </div>
      </div>
